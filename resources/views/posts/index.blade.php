    ...
    <div style="margin-left: 40px; margin-right: 40px; margin-top: 10px; margin-bottom: 50px;">
        ...
        <form method="POST" enctype="multipart/form-data" action="{{ route('post.store') }}" class="text-left">
            ...
            <div class="form-group">
                ...
                <input type="file" class="form-control {{ $errors->has('img') ? ' has-error' : '' }}" id="img" name="img" required></input>
                @if ($errors->has('img'))
                <span class="help-block">
            ...
            <div class="form-group">
                ...
                <small style="font-size: 13px; color: #E74C3C"><i class="fas fa-exclamation-circle" style="margin-right: 3px"></i>Create your pet first</small>
                @else
