            ...
            <div class="card-body">
                    ...
                    <div class="col-1 text-right row" style="margin-top: 10px;">
                        @can('update', $post->user)
                            <i class="far fa-edit" style="color: #F5B041; font-size: 20px" type="button"
                               data-toggle="modal" data-target="#editPostModal" data-placement="top"
                               title="edit post"></i>
                        @endcan
                ...
                <div>
                    <div class="card" style="width: 100%;">
                        <div id="dots"></div>
                        <table class="table table-borderless" id="more">
                            <tbody>
                    ...
                    <form action="{{ route('post.update',['post'=>$post->id])}}" method="post">
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                <label for="question" class="col-sm-3 col-form-label text-left">Post title</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="question" name="question"
                                           placeholder="Enter Question" value="{{$post->question}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="detail" class="col-sm-3 col-form-label text-left">Post detail</label>
                                <div class="col-sm-9">
                                    <textarea type="text" class="form-control" id="detail" name="detail"
                                              placeholder="Enter Detail">{{$post->detail}}</textarea>
                                </div>
                            </div>
