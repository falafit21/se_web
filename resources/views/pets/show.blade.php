                        ...
                        <tbody style="color: black">
                            <tr class="text-center" style="font-size: 19px">
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add" style="margin-left: 1rem;">add vaccine <i class="fas fa-plus"></i>
                                    </button>
                                </td>
                            </tr>
                            <tr class="text-center" style="font-size: 19px">
                                ...
                                <form method="POST" action="{{ route('pet.update', [$pet['id']] ) }}">
                                    ...
                                    <div class="modal-body" style="color: black">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control {{ $errors->has('birth-date-input') ? ' has-error' : '' }}" type="date" value="{{$pet->birth_date}}" id="birth-date-input" name="birth-date-input" required>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <p class="col-6">
                                                <input type="number" class="form-control {{ $errors->has('weight') ? ' has-error' : '' }}" id="weight" name="weight" value="{{$pet->weight}}" required>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="{{ route('pet.vaccine.store', [
                                        ...
                                        <div class="text-right">
                                            <button type="submit" class="btn btn-primary" style="margin-top: 20px">Add
                                            </button>
                                        </div>
                                    </form>
                                </div>
                                    ...
                                    <form method="POST" action="{{ route('pet.vaccine.update',['pet'=>$pet->id]) }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="vaccineName" class="col-sm-4 col-form-label text-left">Vaccine
                                                name</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control {{ $errors->has('vaccineName') ? ' has-error' : '' }}" value="{{ $recieve_vaccine->vaccine->name }}" id="vaccineName" name="vaccineName" required>
                                                @if ($errors->has('vaccineName'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('vaccineName') }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group row">
                                            <label for="receivedDate" class="col-sm-4 col-form-label text-left">Received
                                                Date</label>
                                            <div class="col-sm-8">
                                                <input type="date" class="form-control {{ $errors->has('receiveDate') ? ' has-error' : '' }}" value="{{ $recieve_vaccine->received_at }}" id="receivedDate" name="receivedDate" required>
                                        ...
                                        <div class="form-group row">
                                            <label for="activateRange" class="col-sm-4 col-form-label text-left">Activate range</label>
                                            <div class="col-sm-8">
                                                <input type="number" class="form-control {{ $errors->has('activateRange') ? ' has-error' : '' }}" value="{{ $recieve_vaccine->vaccine->activate_range }}" id="activateRange" name="activateRange" required>
                                                @if ($errors->has('activateRange'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('activateRange') }}</strong>
                                                </span>
